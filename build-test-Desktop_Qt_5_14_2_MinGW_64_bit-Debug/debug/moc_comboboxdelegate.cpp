...
#include <memory>
#include "../../test/comboboxdelegate.h"
...
QT_MOC_LITERAL(1, 14, 24), // "CurrentIndexChangeSignal"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 4), // "iRow"
QT_MOC_LITERAL(4, 45, 7) // "iColumn"

    },
    "ComboDelegate\0CurrentIndexChangeSignal\0"
    "\0iRow\0iColumn"
};
...
void ComboDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CurrentIndexChangeSignal((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComboDelegate::CurrentIndexChangeSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ComboDelegate::CurrentIndexChangeSignal(int _t1, int _t2)const
{
