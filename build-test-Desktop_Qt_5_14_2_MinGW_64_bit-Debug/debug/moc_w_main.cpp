...
struct qt_meta_stringdata_W_main_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_W_main_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_W_main_t qt_meta_stringdata_W_main = {
    {
QT_MOC_LITERAL(0, 0, 6) // "W_main"
...
QT_INIT_METAOBJECT const QMetaObject W_main::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_W_main.data,
    qt_meta_data_W_main,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *W_main::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_W_main.stringdata0))
